...
public class SetSignupUserPersonalInfo extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.fragment_set_signup_user_personal_info, container, false);
    ...
    private void loadSetBirthdayView() {
        ...
        openCalendar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogFragment newFragment = new SetUsersPersonalInfo.DatePickerFragment();
...
//        LocalBroadcastManager.getInstance(mContext).sendBroadcast(new Intent("SHOW_MAP"));
    ...
    private void loadFifthView() {
        ...
        okBtn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dismiss();
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(new Intent("SETTING_USER_PERSONAL_CONTENT"));
            }
        });
    }
